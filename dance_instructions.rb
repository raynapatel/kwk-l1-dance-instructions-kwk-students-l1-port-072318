...
def proper_stance
  ...
  puts "Bend knees slightly"
  puts "Keep posture loose"
end 
...
def bob_the_reins
  ...
  puts "Lift your arms up and dowm in a loose bouncing movement, in time with the beat of the song. This movement is repeated eight times"
end 
def lasso 
